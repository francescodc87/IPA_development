...
#get PeakML type data
PeakML.Data <- PeakML.Read("./RworkingDirectory/TestIPA/allpeaks_filtered.peakml")
...
load("~/RworkingDirectory/TestIPA/data/DBs_all_compounds_only1entry.Rdata")
source('~/RworkingDirectory/TestIPA/R/IPA_massbased_priors.R')
