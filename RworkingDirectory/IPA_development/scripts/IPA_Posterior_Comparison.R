...
source('~/RworkingDirectory/IPA_development/R/PosteriorRelated/IPA_Sampler_ADD_ISO_BIO_Rcpp.R')
...
source('~/RworkingDirectory/IPA_development/R/PosteriorRelated/IPA_Sampler_ADD_ISO_BIO_R.R')
...
# postR <- IPA.sampler.Add.Iso.Bio(P = Prior, Add = adducts, Iso = isotopes, Bio = biotransforamtions, RT = RTs, rel.id = rel.id, Corr.matrix = Corr.matrix)
# postRcpp <- IPA.sampler.Add.Iso.Bio.Rcpp(P = Prior, Add = adducts, Iso = isotopes, Bio = biotransforamtions, RT = RTs, rel.id = rel.id, Corr.matrix = Corr.matrix)
# tmp <- NULL
# for(i in 1:100){
#   postR <- IPA.sampler.Add.Iso.Bio(P = Prior, Add = adducts, Iso = isotopes, Bio = biotransforamtions, RT = RTs, rel.id = rel.id, Corr.matrix = Corr.matrix)
#   postRcpp <- IPA.sampler.Add.Iso.Bio.Rcpp(P = Prior, Add = adducts, Iso = isotopes, Bio = biotransforamtions, RT = RTs, rel.id = rel.id, Corr.matrix = Corr.matrix)
...
#           samplerR = IPA.sampler.Add.Iso.Bio(P = Prior, Add = adducts, Iso = isotopes, Bio = biotransforamtions, RT = RTs, rel.id = rel.id, Corr.matrix = Corr.matrix),
#           samplerRcpp = IPA.sampler.Add.Iso.Bio.Rcpp(P = Prior, Add = adducts, Iso = isotopes, Bio = biotransforamtions, RT = RTs, rel.id = rel.id, Corr.matrix = Corr.matrix),
...
# RTs2 <- c(RTs, RTs, RTs)
# benchmark(replications = 100,
#           samplerR = IPA.sampler.Add.Iso.Bio(P = Prior2, Add = Add2, Iso = Iso2, Bio = Bio2, RT = RTs2),
#           samplerRcpp = IPA.sampler.Add.Iso.Bio.Rcpp(P = Prior2, Add = Add2, Iso = Iso2, Bio = Bio2, RT = RTs2),
#           columns = c('test','elapsed','relative','replications'),
#           order = c('relative'),
#           relative = 'elapsed')
